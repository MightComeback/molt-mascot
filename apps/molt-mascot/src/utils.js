...
import { truncate, cleanErrorString, formatDuration, formatBytes, formatCount, successRate, formatElapsed, formatRelativeTime } from '@molt/mascot-plugin';
export { truncate, cleanErrorString, formatDuration, formatBytes, formatCount, successRate, formatElapsed, formatRelativeTime };
