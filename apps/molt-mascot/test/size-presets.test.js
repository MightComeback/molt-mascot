...
describe("size-presets", () => {
  ...
  describe("findSizePreset", () => {
    it("finds by exact label", () => {
      expect(findSizePreset("small")).toEqual({
        label: "small",
        width: 160,
        height: 140,
      });
      expect(findSizePreset("xlarge")).toEqual({
        label: "xlarge",
        width: 480,
        height: 400,
      });
    ...
    it("is case-insensitive", () => {
      expect(findSizePreset("MEDIUM")).toEqual({
        label: "medium",
        width: 240,
        height: 200,
      });
      expect(findSizePreset("Large")).toEqual({
        label: "large",
        width: 360,
        height: 300,
      });
