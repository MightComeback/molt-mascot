...
export default function register(api: any) {
  ...
  if (typeof on !== "function") {
    ...
    const onToolEnd = async (event: any) => {
      ...
      const isContentTool = ["read", "write", "edit", "exec", "web_fetch", "web_search", "memory_get", "memory_search", "browser", "canvas", "sessions_history", "sessions_list", "agents_list", "tts", "cron", "nodes", "process", "gateway", "slack", "gog", "github", "notion", "gemini", "bird", "bluebubbles", "clawdhub", "peekaboo", "summarize", "video_frames", "weather"].includes(rawToolName);
