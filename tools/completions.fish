...
complete -c molt-mascot -l set-pref -x -a 'alignment sizeIndex size opacityIndex padding opacity clickThrough hideText gatewayUrl draggedPosition sleepThresholdS idleDelayMs errorHoldMs reducedMotion pollIntervalMs reconnectBaseMs reconnectMaxMs staleConnectionMs staleCheckIntervalMs' -d 'Set preference (key=value)'
complete -c molt-mascot -l unset-pref -x -a 'alignment sizeIndex size opacityIndex padding opacity clickThrough hideText gatewayUrl draggedPosition sleepThresholdS idleDelayMs errorHoldMs reducedMotion pollIntervalMs reconnectBaseMs reconnectMaxMs staleConnectionMs staleCheckIntervalMs' -d 'Unset preference (key)'
complete -c molt-mascot -l get-pref -x -a 'alignment sizeIndex size opacityIndex padding opacity clickThrough hideText gatewayUrl draggedPosition sleepThresholdS idleDelayMs errorHoldMs reducedMotion pollIntervalMs reconnectBaseMs reconnectMaxMs staleConnectionMs staleCheckIntervalMs' -d 'Get preference value (key)'
